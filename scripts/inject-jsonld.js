...
const CALCS = [
  ...
  { file: 'calculators/dpo.html',           name: 'DPO Calculator',                 short: 'DPO Calculator',            description: 'Count your days past ovulation (DPO), implantation window, earliest test day and when your period is due.', keywords: 'dpo calculator, days past ovulation, two week wait, test timing' },
  { file: 'calculators/implantation.html',  name: 'Implantation Calculator',        short: 'Implantation Calculator',   description: 'Estimate your implantation window and most likely implantation day from your ovulation date.', keywords: 'implantation calculator, implantation window, implantation timing' },
  { file: 'calculators/trigger-shot.html',  name: 'Trigger Shot Calculator',        short: 'Trigger Shot Calculator',   description: 'Estimate how long an hCG trigger shot may take to clear, to help plan test-out timing for IVF or IUI.', keywords: 'trigger shot calculator, hcg trigger, test out, ovitrelle' },
  { file: 'calculators/beta-hcg.html',      name: 'Beta hCG Doubling Calculator',   short: 'Beta hCG Calculator',       description: 'Calculate beta hCG doubling time and 48-hour rise from two results, for context not diagnosis.', keywords: 'beta hcg calculator, hcg doubling time, hcg rise' },
  { file: 'calculators/ivf-milestones.html', name: 'IVF Milestones Calculator',     short: 'IVF Milestones',            description: 'Map IVF milestones from egg retrieval or embryo transfer through beta tests, scans and your estimated due date.', keywords: 'ivf milestones, ivf timeline, embryo transfer, beta test, due date' }
];
